...
public class CodingLanguegeManager implements CodingLanguageService {
	...
	@Override
	public List<GetByIdCodingLanguageResponse> getById(int id) {
		...
		List<GetByIdCodingLanguageResponse> byIdCodingLanguageResponses = new ArrayList<>();
		List<CodingLanguageSubTechnology> codingLanguageSubTechnology = codingLanguageSubTechnologyRespository
				.findAll();
		List<GetAllCodingLanguageSubTechnologyResponse> allCodingLanguageSubTechnologyResponses = new ArrayList<GetAllCodingLanguageSubTechnologyResponse>();
		...
		for (CodingLanguageSubTechnology codingLanguageSubTechnology2 : codingLanguageSubTechnology) {
			if (codingLanguageSubTechnology2.getCodinglanguage().getId() == codingLanguagegetById.getId()) {
				allCodingLanguageSubTechnologyResponses.add(new GetAllCodingLanguageSubTechnologyResponse(
						codingLanguageSubTechnology2.getId(), codingLanguageSubTechnology2.getName(),
						codingLanguageSubTechnology2.getCodinglanguage().getId()));
			}
		}
		...
		byIdCodingLanguageResponses.add(codinLanguageResponse);
		return byIdCodingLanguageResponses;
	}
